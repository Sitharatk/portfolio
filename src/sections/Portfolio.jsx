...
<p className="text-lg text-gray-300 mb-6 leading-relaxed">
  My core expertise lies in <span className="text-white font-medium">JavaScript, React,Nextjs,Typscript, TailwindCSS,HTML, CSS,PHP, Wordpress and Redux</span>, with additional experience in 
